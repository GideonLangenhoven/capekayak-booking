        ...
        <ThemeProvider>
          ...
          <footer className="mt-14 border-t border-[color:var(--border)]">
            <div className="app-container py-8 text-center text-sm text-[color:var(--textMuted)]">
              <p className="max-w-none">Cape Kayak Adventures · Three Anchor Bay, Sea Point, Cape Town</p>
              <p className="mt-1 max-w-none">Enterprise: 2025/796484/07 · Tax: 9301707270</p>
