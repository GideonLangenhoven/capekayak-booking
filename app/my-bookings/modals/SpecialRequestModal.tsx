    ...
    <Modal open={open} onClose={onClose} title="Special Request">
      <div>
        ...
        <textarea value={specialRequest} onChange={e => setSpecialRequest(e.target.value)}
          ...
          className="w-full border-2 border-[color:var(--border)] rounded-xl p-3 text-[16px] sm:text-sm bg-[color:var(--surface)] text-[color:var(--text)] focus:outline-none focus:border-[color:var(--accent)] resize-none" />
