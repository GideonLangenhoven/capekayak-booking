...
const rowClass =
  "flex w-full items-center gap-3.5 rounded-xl border px-4 py-3.5 text-[color:var(--text)] transition-colors hover:border-[color:var(--accent)]";
const rowStyle = { background: "var(--surface)", borderColor: "var(--border)" } as const;
  ...
  return (
    <Modal open={open} onClose={onClose} title="Contact us">
      <div className="space-y-3">
        ...
        {whatsapp && waDigits && (
          <a href={"https://wa.me/" + waDigits} target="_blank" rel="noopener noreferrer" className={rowClass} style={rowStyle}>
        ...
        {phone && (
          <a href={"tel:" + phone.replace(/\s/g, "")} className={rowClass} style={rowStyle}>
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg" style={chipStyle}>
        ...
        {email && (
          <a href={"mailto:" + email} className={rowClass} style={rowStyle}>
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg" style={chipStyle}>
